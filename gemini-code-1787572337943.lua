-- ============================================
-- @set9p | SILENT AIM (360°) + AUTO TRIGGER (STABLE LOCKED TARGET) + ESP + ANTI-AIM (DOWN)
-- ============================================
...
-- ============================
-- SILENT AIM & AUTO TRIGGER (С ФИКСАЦИЕЙ ЦЕЛИ)
-- ============================
...
RunService.RenderStepped:Connect(function()
    ...
    -- Проверка текущей захваченной цели (жива ли, видна ли)
    ...
    -- Если цель потеряна, ищем ближайшую заново
    ...
    -- Авто-триггер без бесконечного дерганья между целями
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Скрипт обновлен: фиксация цели при двойном скоплении врагов внедрена!",
    Duration = 3,
    Image = 4483362458,
})