-- ============================================
-- @set9p | SILENT AIM + AUTO TRIGGER + SOUND & TRAIL COOLDOWN + ESP
-- ============================================
...
local Settings = {
    ...
    BulletTrailCooldown = 0.3, -- КД трейла в секундах

    -- Звуки триггера и КД
    TriggerSoundEnabled = false,
    TriggerSoundId = "140325083438865",
    TriggerSoundVolume = 1,
    TriggerSoundCooldown = 0.3, -- КД звука в секундах
...
local lastTrailPlayTime = 0 -- Переменная для отслеживания кулдауна трейла
local ESPObjects = {}
local espHighlights = {}
local fovCircle = nil
...
-- ============================
-- СОЗДАНИЕ ТРЕЙЛА ПУЛИ (1 Линия с КД)
-- ============================
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "КД и настройка трейла пули обновлены!",
    Duration = 3,
    Image = 4483362458,
})