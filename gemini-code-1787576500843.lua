-- ============================================
-- @set9p | SILENT AIM + AUTO TRIGGER (SOUNDS) + ESP + ANTI-AIM (DOWN)
-- ============================================
...
CombatTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({
            Title = "Звук",
            Content = "Воспроизведение: " .. Settings.TriggerSoundId,
            Duration = 2,
            Image = 4483362458,
        })
    end
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Добавлены звуки триггера и кнопка предпрослушивания!",
    Duration = 3,
    Image = 4483362458,
})