-- ============================================
-- @set9p | SILENT AIM + AUTO TRIGGER + ANTI-KICK + JUMP SPEED + ESP + BHOP
-- ============================================
...
local jumpSpeedEnabled = true -- Включен контроль скорости прыжка
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Скрипт успешно обновлен (Антикик + Скорость прыжка)!",
    Duration = 3,
    Image = 4483362458,
})