-- ============================================
-- @set9p | SILENT AIM (360°) + ESP + ANTI-AIM + TRIGGERBOT
-- ============================================
...
local Settings = {
    ...
    -- Триггербот (Активация при виде врага, стоп при пропаже)
    TriggerBot = false,
    TriggerDelay = 0,
...
-- ============================
-- ТРИГГЕРБОТ (АКТИВАЦИЯ ПРИ ВИДЕ ВРАГА И СТОП ПРИ ПРОПАЖЕ)
-- ============================
            ...
            if enemyInSight then
                if not isShooting then
                    ...
                    task.spawn(function()
                        ...
                        while isShooting and Settings.TriggerBot do
                            if mouse1click then
                                mouse1click()
                            end
                            task.wait(0.2)
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Скрипт полностью обновлен!",
    Duration = 3,
    Image = 4483362458,
})